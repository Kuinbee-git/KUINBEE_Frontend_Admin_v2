...
export function UpdateRequestTable({ proposals, onRowClick, onPickProposal }: UpdateRequestTableProps) {
      ...
      <tbody>
        {proposals.map((proposal) => (
          ...
          >
            ...
            <td className="p-4">
              {!proposal.assignedTo && ["SUBMITTED", "RESUBMITTED"].includes(proposal.verificationStatus) && onPickProposal && (
                <Button
                  variant="outline"
                  size="sm"
